...
d_sf = 20;%8.9*wave_height;%0.018*wave_height*wave_period*sqrt(g./(R*grain_size)); % %depth shoreface m %Hallermeier (1983) or  houston (1995)
fprintf(['shoreface depth set to ' num2str(d_sf) '\n'])
